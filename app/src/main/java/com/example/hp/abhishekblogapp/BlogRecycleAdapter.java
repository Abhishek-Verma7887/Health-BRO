...
//        holder.setIsRecyclable(false);
        ...
        String topicNameName = blogList.get(position).getTopicNameName();
        holder.setTopicNameName(topicNameName);
...
//        String dateString1 = DateFormat.format("E, dd MMM yy", new Date(millisecond)).toString();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setTopicNameName(String topicName){
            topicNameView= mview.findViewById(R.id.Real_topic_name_in_blogList);
